...
def main():
  ...
  bkg_filename = config.get('bkg_filename', "./MOM.res.nc")
  ...
  print(gridspec_filename,bkg_filename,mld_filename,output_filename)
  ...
  with nc.Dataset(bkg_filename, 'r') as src:
    h = src.variables['h'][0]
