...
export HOMEBASE=/gpfs/f5/cpchso/scratch/Yongzuo.Li/RTOFS2IODA_ObsQC
export database=${HOMEBASE}/profile
cd ${HOMEBASE}
...
rm profile.bin profile.txt profile_all.txt
 ...
 ls -l ${database}/${YMD}00.profile
ln -sf ${database}/${YMD}00.profile profile.bin

./rtofs_obs_read.x read_profile
...
echo ------ This is next time $date_YMDH ------
