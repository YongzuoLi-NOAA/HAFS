...
HOMEhafs=${HOMEhafs:-/work2/noaa/hwrf/yongzuo/HAFS}
source ${HOMEhafs}/ush/hafs_pre_job.sh.inc

export JEDI_SOCA_3DVAR='YES'
## export JEDI_SOCA_3DVAR='NO'
...
#===============================================================================
 ...
 #./run_hafs.py ${opts} 2020082500 13L HISTORY ${confopts} \
 #   config.NHRS=126 config.scrub_work=no config.scrub_com=no config.run_emcgraphics=yes

./run_hafs.py ${opts} 2022092300 09L HISTORY ${confopts} \
    config.NHRS=6 config.scrub_work=no config.scrub_com=no config.run_emcgraphics=yes
